...
class Audio_Player(App):
    ...
    def getAlsaVolume(self, *largs):
        volume_string = subprocess.check_output(
            ['amixer', '-c', '1', 'get', 'Digital'])[172:177]
    ...
    def buttonCallback(self):
        ...
        self.process = subprocess.Popen('mplayer -nolirc -ao alsa:device=hw=1,0 "{0}"'.format(
            '/home/pi/Music/08 - Strawberry Fields Forever (2009 Digital Remaster).m4a'), shell=True, stdout=subprocess.PIPE, stdin=subprocess.PIPE)
        print 'button'
        self.getAlsaVolume()
